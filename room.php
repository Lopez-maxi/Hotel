<?php  include("admin/bd.php");
 ...
 $lista_habitaciones=$sentencia->fetchAll(PDO::FETCH_ASSOC);
  ...
  //MOSTRAMOS LOS REGISTROS DE TESTIMONIOA
                    ...
                    <nav class="navbar navbar-expand-lg bg-dark navbar-dark p-3 p-lg-0">
                        ...
                        <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                            <div class="navbar-nav mr-auto py-0">
                                ...
                                <a href="room.php" class="nav-item nav-link active">Habitaciones</a>
           ...
           <div class="container-fluid page-header mb-5 p-0" style="background-image: url(img/carousel-1.jpg);">
            <div class="container-fluid page-header-inner py-5">
                <div class="container text-center pb-5">
                    <h1 class="display-3 text-white mb-3 animated slideInDown"><?php echo $lista_configuraciones[30]['valor'];?></h1>
