...
if(isset($_GET['txtid'])){
  ...
  if($_POST){
    ...
    SET nombre=:nombre,profesion=:profesion WHERE id=:id ");
        ...
        <form action="" enctype="multipart/form-data" method="post">
          <div class="mb-3">
            ...
            <div class="mb-3">
              ...
              <input type="text"
                class="form-control" value="<?php echo $nombre;?>" name="nombre" id="nombre" aria-describedby="helpId" placeholder="titulo">
            </div>
            
            <div class="mb-3">
              <label for="profesion" class="form-label">profesion</label>
              <input type="text"
                class="form-control" value="<?php echo $profesion;?>" name="profesion" id="profesion" aria-describedby="helpId" placeholder="descripcion">
            </div>
            <div class="mb-3">
