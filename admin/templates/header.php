...
session_start();
$url_base="http://localhost/proyecto-final/admin/";
    ...
    <!-- place navbar here -->
        ...
        <nav class="navbar navbar-expand navbar-light bg-light">
            <div class="nav navbar-nav">
                <a class="nav-item nav-link active" href="../pagprin.php" aria-current="page">Home <span class="visually-hidden">Administrador</span></a>
                <a class="nav-item nav-link" href="<?php echo $url_base;?>secciones/nosotros">Nosotros</a>
                <a class="nav-item nav-link" href="<?php echo $url_base;?>secciones/servicios">Servicios</a>
                <a class="nav-item nav-link" href="<?php echo $url_base;?>secciones/habitaciones">Habitaciones</a>
